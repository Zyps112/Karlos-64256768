...
public class LobbyManager : MonoBehaviour
{
    ...
    private async void CreateLobby()
    {
        ...
        try
        {
            ...
            CreateLobbyOptions createLobbyOptions = new CreateLobbyOptions
            {
                ...
                {
                    { "GameMode", new DataObject(DataObject.VisibilityOptions.Public, "Hard") },
    ...
    private async void ListLobbies()
    {
        try
        {
            QueryLobbiesOptions queryLobbiesOpetions = new QueryLobbiesOptions
            {
                Count = 25,
            ...
            QueryResponse queryResponse = await Lobbies.Instance.QueryLobbiesAsync(queryLobbiesOpetions);
    ...
    [ContextMenu("Update Lobby GameMode")]
    ...
    [ContextMenu("Migrate Lobby Host")]
